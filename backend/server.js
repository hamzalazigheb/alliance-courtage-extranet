...
const gammeProductsRoutes = require('./routes/gammeProducts');
...
// Middleware pour garantir UTF-8 encoding pour les réponses JSON
...
app.use('/api/gamme-products', gammeProductsRoutes);
